        ...
        this.server.on('client', client => {
            ...
            client.onData = (data, next) => {
                ...
                if (!client) {
                    ...
                    console.log('client not found for ', data.req);
                    return;
                }
                ...
                if (!data.req) {
                    // ignore
                    console.log(client.id + ' ignore ', data);
                    return;
                }
                ...
                console.log(client.id + ' received cmd', data);
                ...
                switch (data.cmd) {
                    ...
                    case 'GET':
                        return this.findNext(client.zone, data, (err, delivery) => {
                            ...
                            console.log(client.id + ' returing response for ', data.req);
                            client.send({
                                req: data.req,
                                response: delivery
                            });
                    ...
                    case 'DEFER':
                        return this.deferDelivery(client.zone, data, (err, response) => {
                            ...
                            if (err) {
                                console.log(client.id + ' returing error response for ', data.req);
                                return client.send({
                                    req: data.req,
                                    error: err.message || err
                                });
                            }
                            console.log(client.id + ' returing normal response for ', data.req);
                            client.send({
                                req: data.req,
                                response
                            });

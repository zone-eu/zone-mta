...
const deliveryStatusCounter = new promClient.Counter({ name: 'zonemta_delivery_status', help: 'Delivery status', labelNames: ['result'] });
const messagePushCounter = new promClient.Counter({ name: 'zonemta_message_push', help: 'Messages pushed to queue', labelNames: ['result'] });
const bounceCounter = new promClient.Counter({ name: 'zonemta_bounce_generation', help: 'Bounce generation' });
const dropCounter = new promClient.Counter({ name: 'zonemta_message_drop', help: 'Messages dropped' });

        ...
        this.server.on('client', client => {
            ...
            client.onData = (data, next) => {
                ...
                if (!client) {
                    ...
                    console.log('S: client not found for ', data.req);
                    return;
                }
                ...
                if (!data.req) {
                    // ignore
                    console.log('S: ' + client.id + ' ignore ', data);
                    return;
                }
                ...
                console.log('S: ' + client.id + ' received cmd', data);
                ...
                switch (data.cmd) {
                    ...
                    case 'GET':
                        return this.findNext(client.zone, data, (err, delivery) => {
                            ...
                            if (err) {
                                console.log('S: ' + client.id + ' returing response ', {
                                    req: data.req,

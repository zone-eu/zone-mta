...
const queueSizeGauge = new promClient.Gauge({ name: 'zonemta_queue_size', help: 'Current size of the queue', labelNames: ['type'] });
const blacklistedGauge = new promClient.Gauge({ name: 'zonemta_blacklisted', help: 'Blacklisted addresses' });

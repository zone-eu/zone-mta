...
class MailQueue {
    ...
    decStats(zone, domain) {
        ...
        console.log(this.stats.domainQueued.has(domain));
        if (this.stats.domainQueued.has(domain)) {
            console.log(this.stats.domainQueued.get(domain).queued);

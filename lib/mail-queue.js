        ...
        let tryNext = () => {
            collection.findOneAndUpdate(
                ...
                (err, item) => {
                    ...
                    if (!item || !item.value) {
                        // nothing found, disable this zone for a few seconds
    ...
    releaseDelivery(delivery, callback) {
        ...
        collection.deleteOne(
            ...
            err => {
                ...
                // flush empty queue cache as in some cases the queue is deemed only empty because
                // it contains locked domains. if a delivery is released then the domain might get unlocked
                this.cache.remove('empty:' + delivery.sendingZone);

...
class Sender extends EventEmitter {
    ...
    constructor(clientId, connectionId, zone, queue) {
        super();
        ...
        this.queue.setupSubscriber((...args) => this.sendNext(...args));
    }
    ...
    sendNext(delivery, response) {
        ...
        let handleError = (delivery, connection, err) => {
            ...
            responseSent = true;
            this.handleResponseError(delivery, connection, err, () => response.nack());
        };
